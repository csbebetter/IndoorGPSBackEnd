...
//            }
            String hostname = "115.156.142.223";
            ...
            antennas.getAntenna((short) 1).setTxPowerinDbm(19.0);
            antennas.getAntenna((short) 1).setRxSensitivityinDbm(-70);
            antennas.getAntenna((short) 2).setTxPowerinDbm(19.0);
            antennas.getAntenna((short) 2).setRxSensitivityinDbm(-70);
            antennas.getAntenna((short) 3).setTxPowerinDbm(19.0);
            antennas.getAntenna((short) 3).setRxSensitivityinDbm(-70);
            antennas.getAntenna((short) 4).setTxPowerinDbm(19.0);
