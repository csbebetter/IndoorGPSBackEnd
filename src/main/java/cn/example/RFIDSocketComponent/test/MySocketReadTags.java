package cn.example.RFIDSocketComponent.test;

import cn.example.RFIDSocketComponent.config.RFIDSocketConfig;
import cn.example.RFIDSocketComponent.impl.AllInfoTagReportListenerImpl;
import com.impinj.octane.*;

import java.util.Scanner;

public class MySocketReadTags {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            reader.connect(RFIDSocketConfig.RFIDReaderHostname);
